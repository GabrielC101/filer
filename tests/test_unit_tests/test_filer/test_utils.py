...
from filer.utils import remove_nondigits, get_path_type, is_image, get_size, get_inode, atime, mtime, ctime, \
...
@patch('filer.utils.isfile', return_value=True)
@patch('filer.utils.isdir', return_value=False)
@patch('filer.utils.exists', return_value=True)
...
@patch('filer.utils.isfile', return_value=False)
@patch('filer.utils.isdir', return_value=True)
@patch('filer.utils.exists', return_value=True)
...
@patch('filer.utils.magic.from_file', return_value='image/jpeg')
@patch('filer.utils.isfile', return_value=True)
...
@patch('filer.utils.magic.from_file', return_value='application/pdf')
@patch('filer.utils.isfile', return_value=True)
...
@patch('filer.utils.os.stat', return_value=type('TestClass', (), {'st_size': 1}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass1', (), {'st_size': 2}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass', (), {'st_ino': 1}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass1', (), {'st_ino': 2}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass', (), {'st_atime': 1507390145}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass1', (), {'st_atime': 15073901111}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass', (), {'st_mtime': 1507390145}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass1', (), {'st_mtime': 15073901111}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass', (), {'st_ctime': 1507390145}))
...
@patch('filer.utils.os.stat', return_value=type('TestClass1', (), {'st_ctime': 15073901111}))
